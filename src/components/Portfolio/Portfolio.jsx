            ...
            <div className={s.portfolioWrapper}>
              ...
              <motion.div className={s.projectBox} initial='hidden'
                ...
                <ul className={s.linksList}>
                  <li><a href='https://kapusta-project-app.netlify.app/main' target="_blank"  rel="noopener noreferrer"><BiLinkAlt className={s.listIcon}/></a></li>
                  <li><a href='https://github.com/Mr-Nihility/kapusta-project' target="_blank"  rel="noopener noreferrer"><FiGithub className={s.listIcon}/></a></li>
                </ul>
              </motion.div>
              ...
              <motion.div className={s.projectBox} initial='hidden'
                ...
                <ul className={s.linksList}>
                  <li><a href='https://spotify-clone-music-app.netlify.app/' target="_blank"  rel="noopener noreferrer"><BiLinkAlt className={s.listIcon}/></a></li>
                  <li><a href='https://github.com/RoRomario360/my-music-app' target="_blank"  rel="noopener noreferrer"><FiGithub className={s.listIcon}/></a></li>
                </ul>
              </motion.div>
              ...
              <motion.div className={s.projectBox} initial='hidden'
                ...
                <ul className={s.linksList}>
                  <li><a href='https://redokleeroy.github.io/let_JS_project/' target="_blank" rel="noreferrer"><BiLinkAlt className={s.listIcon}/></a></li>
                  <li><a href='https://github.com/RedokLeeroy/let_JS_project' target="_blank" rel="noreferrer"><FiGithub className={s.listIcon}/></a></li>
                </ul>
              </motion.div>
              ...
              <motion.div className={s.projectBox} initial='hidden'
                ...
                <ul className={s.linksList}>
                  <li><a href='https://yehorboichenko.github.io/crazy-bears/' target="_blank" rel="noreferrer"><BiLinkAlt className={s.listIcon}/></a></li>
                  <li><a href='https://github.com/YehorBoichenko/crazy-bears' target="_blank" rel="noreferrer"><FiGithub className={s.listIcon}/></a></li>
                </ul>
              </motion.div>
            </div>
